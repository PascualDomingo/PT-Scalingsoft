...
// Verificar que la solicitud sea GET
 if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->bind_param("iissss", $p_userId, $p_roleId, $p_firstName, $p_lastName, $p_password, $p_modifiedUser);
    $stmt->execute();
    ...
    if ($stmt->affected_rows > 0) {
        ...
        $response['error'] = "Error al modificar el usuario: " . $stmt->error;
    }
